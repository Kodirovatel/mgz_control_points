...
def analytics(filename):
    ...
    df['% год'] = df['Год\nФакт'] / df['Год\nПлан']
    df['% I квартал'] = df['I квартал факт'] / df['I квартал план']
    df['% II квартал'] = df['II квартал нарастающим итогом факт'] / df['II квартал нарастающим итогом план']
    df['% III квартал'] = df['III квартал нарастающим итогом факт'] / df['III квартал нарастающим итогом план']
    df['% IV квартал'] = df['IV квартал нарастающим итогом факт'] / df['IV квартал нарастающим итогом план']
    ...
    df = df.groupby('Отрасль').agg('sum').sort_values('Год\nПлан', ascending=False).apply(lambda x: x/1000000)
    ...
    df['% III квартал'] = df['III квартал нарастающим итогом факт'] / df['III квартал нарастающим итогом план']
    df['% IV квартал'] = df['IV квартал нарастающим итогом факт'] / df['IV квартал нарастающим итогом план']
    df['% плана от года\nI квартал'] = df['I квартал план'] / df['Год\nПлан']
    df['% плана от года\nII квартал'] = df['II квартал нарастающим итогом план'] / df['Год\nПлан']
    df['% плана от года\nIII квартал'] = df['III квартал нарастающим итогом план'] / df['Год\nПлан']
    df['% плана от года\nIV квартал'] = df['IV квартал нарастающим итогом план'] / df['Год\nПлан']
    df = df[['Отрасль',
        'Год\nПлан',
        'Год\nФакт',
        '% год',
